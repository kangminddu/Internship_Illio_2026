...
CASE
    WHEN ct.content_type='shorts' THEN '쇼츠'
    WHEN ct.content_type='video' THEN '롱폼'
...
for row in ws.iter_rows(min_row=2):
    for cell in row:
        cell.border = border
        if cell.column in [1, 4, 5, 6, 7, 8, 9, 10, 11, 13]:
            cell.alignment = center
...
# 열 너비
widths = {
    "A": 8, "B": 20, "C": 16, "D": 14, "E": 14, "F": 10, "G": 14,
    "H": 12, "I": 12, "J": 12, "K": 12, "L": 16, "M": 10, "N": 55,
}
